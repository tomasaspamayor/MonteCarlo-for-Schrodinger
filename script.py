...
samples_gaussian_r = samp.rejection_sampling(samp.normalized_gaussian, 1, -1, 1, 100000, 1e8)
samples_exponential_r = samp.rejection_sampling(samp.normalized_exponential, 1, 0, 1, 100000, 1e8)

samp.plot_samples(samp.normalized_gaussian, [-1, 1], samples_gaussian_r, 50, 0)
samp.plot_samples(samp.normalized_exponential, [0, 1], samples_exponential_r, 50, 0)

samples_gaussian_mh = samp.metropolis_hastings(samp.normalized_gaussian, 0, [-1, 1], 0.5, 100000)
samples_exponential_mh = samp.metropolis_hastings(samp.normalized_exponential, 0.5, [0, 1], 0.5, 100000)
samp.plot_samples(samp.normalized_gaussian, [-1, 1], samples_gaussian_mh, 50, 1)
samp.plot_samples(samp.normalized_exponential, [0, 1], samples_exponential_mh, 50, 1)
